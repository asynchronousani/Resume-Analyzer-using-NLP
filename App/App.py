...
# sql connector
connection = pymysql.connect(host='localhost',user='root',password='Aniadi2918@',db='cv')
...
def run():
    ...
    link = '<b>Built with 🤍 by <a style="text-decoration: none; color: #021659;">Anirudh Varshney</a></b>' 
    ...
    ###### CODE FOR ABOUT PAGE ######
        ...
        <p align="justify">
            Built with 🤍 by 
            <a style="text-decoration: none; color: grey;">Anirudh Varshney</a> through 
    ...
    ###### CODE FOR ADMIN SIDE (ADMIN) ######
        ...
        if st.button('Login'):
            ...
            if ad_user == 'admin' and ad_password == 'admin@resume-analyzer':
                ...
                st.success("Welcome Anirudh ! Total %d " % values + " User's Have Used Our Tool : )")                
